...
const MyAppointment = () => {
  ...
  const [appointments, setAppointments] = useState([]);   // state variable to store the appointment data
  ...
  // api call to get user appointments
  ...
  const cancelAppointment = async (appointmentId) => {
    try {
      ...
      if (data.success) {
        ...
        // updates the docdata when user cancelled the appointment automatically
        getDoctorsData();
  ...
  // api call to make the online payment using the razorpay
